<?php /* Smarty version Smarty-3.1.8, created on 2014-06-27 01:12:50
         compiled from "/var/www/vipinsg/admin_vipinsg/themes/default/template/controllers/home/content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:189265716953ac5492cce5e5-95267870%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e981d1ada1b63b661d11b472da055b55a7e44715' => 
    array (
      0 => '/var/www/vipinsg/admin_vipinsg/themes/default/template/controllers/home/content.tpl',
      1 => 1403802536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '189265716953ac5492cce5e5-95267870',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53ac5492d3db60_73446497',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53ac5492d3db60_73446497')) {function content_53ac5492d3db60_73446497($_smarty_tpl) {?>
...
<div id="homepage">
	...
	<div id="column_left">
		...
		<?php if ($_smarty_tpl->tpl_vars['upgrade']->value->need_upgrade){?>
			<div class="warning warn" style="margin-bottom:10px;"><h3><?php echo smartyTranslate(array('s'=>'New version of PrestaShop is available'),$_smarty_tpl);?>
...
" target="_blank"><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->tpl_vars['upgrade']->value->version_name;?>
	...
	<?php }else{ ?>
		<p><?php echo smartyTranslate(array('s'=>'Update notification unavailable'),$_smarty_tpl);?>
</p>
		<p>&nbsp;</p>
		<p><?php echo smartyTranslate(array('s'=>'To receive PrestaShop update warnings, you need to activate'),$_smarty_tpl);?>
...
" id="screencast_fancybox"><img height="128" width="220" src="../img/admin/preview_fr.jpg" /><span class="mask-player"></span></a>
			...
			<p><?php echo smartyTranslate(array('s'=>'Take part in the e-commerce adventure with PrestaShop, the fast, powerful, and customizable e-commerce solution. With more than 275 features, PrestaShop will help you create a world of opportunities without limits. Discover the solution that already powers more than 120,000 active stores worldwide!'),$_smarty_tpl);?>
</p>
			</div>
	<div id="footer_iframe_home">
		...
		<label for="screencast_dont_show_again"><?php echo smartyTranslate(array('s'=>'Do not show again'),$_smarty_tpl);?>
</label>
	</div>
