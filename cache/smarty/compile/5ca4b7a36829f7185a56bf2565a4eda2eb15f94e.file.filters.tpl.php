<?php /* Smarty version Smarty-3.1.8, created on 2014-06-27 01:13:41
         compiled from "/var/www/vipinsg/admin_vipinsg/themes/default/template/controllers/modules/filters.tpl" */ ?>
<?php /*%%SmartyHeaderCode:208774182653ac54c5d22d50-35107191%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5ca4b7a36829f7185a56bf2565a4eda2eb15f94e' => 
    array (
      0 => '/var/www/vipinsg/admin_vipinsg/themes/default/template/controllers/modules/filters.tpl',
      1 => 1403802536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '208774182653ac54c5d22d50-35107191',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53ac54c5e4e456_77993556',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53ac54c5e4e456_77993556')) {function content_53ac54c5e4e456_77993556($_smarty_tpl) {?>
		...
		<?php }else{ ?>
			...
			<div class="filter-module" id="addons_login_div">
				...
				<form id="addons_login_form" method="post">
					<label><?php echo smartyTranslate(array('s'=>'Login to Addons'),$_smarty_tpl);?>
...
?>
					...
					<select name="module_install" id="module_install_filter" <?php if ($_smarty_tpl->tpl_vars['showInstalledModules']->value!='installedUninstalled'&&$_smarty_tpl->tpl_vars['showInstalledModules']->value!=''){?>style="background-color:#49B2FF;color:white;"<?php }?>>
						...
						<option value="uninstalled" <?php if ($_smarty_tpl->tpl_vars['showInstalledModules']->value=='uninstalled'){?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Not Installed Modules'),$_smarty_tpl);?>
</option>
					</select>
					&nbsp;
