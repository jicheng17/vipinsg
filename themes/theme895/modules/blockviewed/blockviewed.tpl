	...
	<div class="block_content toggle_content">
		<ul class="products ">
			{foreach from=$productsViewedObj item=viewedProduct name=myLoop}
				<li class="clearfix">
                    <a class="products_block_img bordercolor" href="{$viewedProduct->product_link|escape:'html'}" title="{l s='About' mod='blockviewed'} {$viewedProduct->name|escape:html:'UTF-8'}" class="content_img">
					...
					<div>
	<h5><a class="product_link" href="{$viewedProduct->product_link|escape:'html'}" title="{l s='More about' mod='blockviewed'} {$viewedProduct->name|escape:html:'UTF-8'}">{$viewedProduct->name|truncate:25:'...'|escape:html:'UTF-8'}</a></h5>
