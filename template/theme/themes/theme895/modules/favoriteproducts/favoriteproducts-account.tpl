...
<div id="favoriteproducts_block_account">
	<h1><span>{l s='My favorite products.' mod='favoriteproducts'}</span></h1>
	{if $favoriteProducts}
		<ul>
	...
	{else}
		<p class="alert alert-info">{l s='No favorite products have been determined just yet. ' mod='favoriteproducts'}</p>
	{/if}

	<ul class="footer_links clearfix">
		<li class="fleft">
			
			<a href="{$link->getPageLink('my-account', true)|escape:'htmlall':'UTF-8'}"><i class="icon-user"></i> {l s='Back to your account.' mod='favoriteproducts'}</a></li>
	</ul>
</div>