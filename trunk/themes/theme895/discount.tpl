...
<h1><span>{l s='My vouchers'}</span></h1>
...
<div id="discount_table">
    <table class="discount footable table table-hover table-bordered">
        <thead>
            <tr>
                <th data-class="expand" class="discount_code first_item">{l s='Code'}</th>
                <th data-hide="phone" class="discount_description item">{l s='Description'}</th>
                <th data-hide="phone" class="discount_quantity item">{l s='Quantity'}</th>
                <th data-hide="phone" class="discount_value item">{l s='Value'}*</th>
                ...
                <th data-hide="phone,tablet" class="discount_expiration_date last_item">{l s='Expiration date'}</th>
            </tr>
        </thead>
        <tbody>
...
{else}
	<p class="alert alert-info">{l s='You do not have any vouchers.'}</p>
{/if}
