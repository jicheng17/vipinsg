<?php /* Smarty version Smarty-3.1.8, created on 2014-06-28 16:05:05
         compiled from "/var/www/vipinsg/themes/theme895/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53997549253ae6fd9b45373-62546829%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '72d0105cadde7ec738bb60e72d578359893e06c1' => 
    array (
      0 => '/var/www/vipinsg/themes/theme895/modules/blockcart/blockcart.tpl',
      1 => 1403942698,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53997549253ae6fd9b45373-62546829',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_53ae6fd9d23c88_12260939',
  'variables' => 
  array (
    'ajax_allowed' => 0,
...
<?php if ($_valid && !is_callable('content_53ae6fd9d23c88_12260939')) {function content_53ae6fd9d23c88_12260939($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_replace')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.replace.php';
?>
...
';
	var addedSuccessfully = '<?php echo smartyTranslate(array('s'=>'Your product has been successfully added to your cart!','mod'=>'blockcart','js'=>1),$_smarty_tpl);?>
';
...
';
	var ajaxcart_allowed = <?php if ((isset($_smarty_tpl->tpl_vars['ajax_allowed']->value))&&($_smarty_tpl->tpl_vars['ajax_allowed']->value==1)){?>1<?php }else{ ?>0<?php }?>;
...
">
			<?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['name'],13,'...'), 'html', 'UTF-8');?>
				...
				<span class="remove_link"><?php if (!isset($_smarty_tpl->tpl_vars['customizedDatas']->value[$_smarty_tpl->tpl_vars['productId']->value][$_smarty_tpl->tpl_vars['productAttributeId']->value])&&(!isset($_smarty_tpl->tpl_vars['product']->value['is_gift'])||!$_smarty_tpl->tpl_vars['product']->value['is_gift'])){?><a rel="nofollow" class="ajax_cart_block_remove_link" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".($_smarty_tpl->tpl_vars['product']->value['id_product'])."&amp;ipa=".($_smarty_tpl->tpl_vars['product']->value['id_product_attribute'])."&amp;id_address_delivery=".($_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".($_smarty_tpl->tpl_vars['static_token']->value),true), ENT_QUOTES, 'UTF-8');?>
...
<?php $_tmp2=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_customization=".($_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".($_smarty_tpl->tpl_vars['static_token']->value),true), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow"><i class="icon-trash"></i></a></div>
	...
	<?php }?>
		<p <?php if ($_smarty_tpl->tpl_vars['products']->value){?>class="unvisible no_products" <?php }else{ ?>class="cart_no_products"  <?php }?>id="cart_block_no_products" ><?php echo smartyTranslate(array('s'=>'No products','mod'=>'blockcart'),$_smarty_tpl);?>
</p>
...
<?php }?></span>
		...
		<p id="cart-buttons" class="">
			<?php if ($_smarty_tpl->tpl_vars['order_process']->value=='order'){?><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(($_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8');?>
" class="button_mini btn btn-default" title="<?php echo smartyTranslate(array('s'=>'View my shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
...
" id="button_order_cart" class="exclusive<?php if ($_smarty_tpl->tpl_vars['order_process']->value=='order-opc'){?>_large<?php }?> btn btn-default" title="<?php echo smartyTranslate(array('s'=>'Check out','mod'=>'blockcart'),$_smarty_tpl);?>
