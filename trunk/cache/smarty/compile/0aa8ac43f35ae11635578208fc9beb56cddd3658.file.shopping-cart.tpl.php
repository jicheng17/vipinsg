<?php /* Smarty version Smarty-3.1.8, created on 2014-06-28 16:09:04
         compiled from "/var/www/vipinsg/themes/theme895/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:208952839653ae782043c483-78268340%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0aa8ac43f35ae11635578208fc9beb56cddd3658' => 
    array (
      0 => '/var/www/vipinsg/themes/theme895/shopping-cart.tpl',
      1 => 1403942698,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '208952839653ae782043c483-78268340',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53ae78207bee68_81496714',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53ae78207bee68_81496714')) {function content_53ae78207bee68_81496714($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.escape.php';
?>
...
<h1 id="cart_title"><span><?php echo smartyTranslate(array('s'=>'Shopping-cart summary'),$_smarty_tpl);?>
</span></h1>
...
<?php if (isset($_smarty_tpl->tpl_vars['empty']->value)){?>
	<p class="alert alert-info"><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
<button class="close" data-dismiss="alert" type="button">×</button></p>
<?php }elseif($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
	<p class="alert alert-info"><?php echo smartyTranslate(array('s'=>'This store has not accepted your new order.'),$_smarty_tpl);?>
<button class="close" data-dismiss="alert" type="button">×</button></p>
<?php }else{ ?>
...
;
	...
	<p style="display:none" id="emptyCartWarning" class="alert alert-info"><?php echo smartyTranslate(array('s'=>'Your shopping cart is empty.'),$_smarty_tpl);?>
</p>
  
<p class="ordercart-title"><b><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
		...
		<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value){?>
			<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
				<tr class="cart_total_price ">
					<td><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
			...
			<?php }else{ ?>
				<tr class="cart_total_price">
					<td><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total products (tax incl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total products'),$_smarty_tpl);?>
<?php }?></td>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0&&!isset($_smarty_tpl->tpl_vars['virtualCart']->value)){?>
				<tr class="cart_total_delivery" style="<?php if (!isset($_smarty_tpl->tpl_vars['carrier']->value->id)||is_null($_smarty_tpl->tpl_vars['carrier']->value->id)){?>display:none;<?php }?>">
					<td ><?php echo smartyTranslate(array('s'=>'Shipping'),$_smarty_tpl);?>
</td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value!=$_smarty_tpl->tpl_vars['total_shipping']->value){?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value){?>
						<tr class="cart_total_delivery" <?php if ($_smarty_tpl->tpl_vars['total_shipping_tax_exc']->value<=0){?> style="display:none;"<?php }?>>
							<td ><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
					...
					<?php }else{ ?>
						<tr class="cart_total_delivery"<?php if ($_smarty_tpl->tpl_vars['total_shipping']->value<=0){?> style="display:none;"<?php }?>>
							<td ><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value){?><?php echo smartyTranslate(array('s'=>'Total shipping (tax incl.)'),$_smarty_tpl);?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
<?php }?></td>
...
?>
			...
			<?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['tpl_dir']->value)."./shopping-cart-product-line.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('productLast'=>$_smarty_tpl->tpl_vars['product']->last,'productFirst'=>$_smarty_tpl->tpl_vars['product']->first), 0);?>
...
<?php $_tmp2=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp1."&amp;ipa=".$_tmp2."&amp;id_address_delivery=".($_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;id_customization=".($_smarty_tpl->tpl_vars['id_customization']->value)."&amp;op=down&amp;token=".($_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8');?>
...
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp3."&amp;ipa=".$_tmp4."&amp;id_address_delivery=".($_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;id_customization=".($_smarty_tpl->tpl_vars['id_customization']->value)."&amp;token=".($_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8');?>
...
<?php $_tmp6=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp5."&amp;ipa=".$_tmp6."&amp;id_customization=".($_smarty_tpl->tpl_vars['id_customization']->value)."&amp;id_address_delivery=".($_smarty_tpl->tpl_vars['product']->value['id_address_delivery'])."&amp;token=".($_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8');?>
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value['quantity']-$_smarty_tpl->tpl_vars['quantityDisplayed']->value>0){?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['tpl_dir']->value)."./shopping-cart-product-line.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('productLast'=>$_smarty_tpl->tpl_vars['product']->last,'productFirst'=>$_smarty_tpl->tpl_vars['product']->first), 0);?>
<?php }?>
			<?php }?>
		<?php } ?>
...
<?php }?>
                ...
                <div class="insset-bottom">
                <span class="title-th"><?php echo smartyTranslate(array('s'=>'Qty'),$_smarty_tpl);?>
:</span>
...
<?php }?>" />
                        ...
                        <div class="titled_box">
							<h2 class="title_offers"><span><?php echo smartyTranslate(array('s'=>'Take advantage of our offers:'),$_smarty_tpl);?>
</span></h2>
                        </div>
...
<?php }?>" class="exclusive btn btn-default standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
...
<?php }?>" class="button_large btn btn-default" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
