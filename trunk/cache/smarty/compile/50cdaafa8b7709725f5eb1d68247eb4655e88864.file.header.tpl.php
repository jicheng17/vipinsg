<?php /* Smarty version Smarty-3.1.8, created on 2014-06-27 01:12:10
         compiled from "/var/www/vipinsg/admin_vipinsg/themes/default/template/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:92607325153ac546a08d6e9-42679570%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50cdaafa8b7709725f5eb1d68247eb4655e88864' => 
    array (
      0 => '/var/www/vipinsg/admin_vipinsg/themes/default/template/header.tpl',
      1 => 1403802536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92607325153ac546a08d6e9-42679570',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53ac546a2dc3d5_96406970',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53ac546a2dc3d5_96406970')) {function content_53ac546a2dc3d5_96406970($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.escape.php';
?>
...
';
		var _PS_VERSION_ = '<?php echo @_PS_VERSION_;?>
';
...
</span></a><div id="notifs_icon_wrapper">
...
"><?php echo smartyTranslate(array('s'=>'Show all messages'),$_smarty_tpl);?>
		...
		<div id="employee_links">
			<span class="employee_name"><?php echo $_smarty_tpl->tpl_vars['first_name']->value;?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['last_name']->value;?>
</span>
			<span class="separator">&nbsp;</span>
			<a class="employee" href="index.php?controller=AdminEmployees&amp;id_employee=<?php echo $_smarty_tpl->tpl_vars['employee']->value->id;?>
&amp;updateemployee&amp;token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0][0]->getAdminTokenLiteSmarty(array('tab'=>'AdminEmployees'),$_smarty_tpl);?>
" alt=""><?php echo smartyTranslate(array('s'=>'My preferences'),$_smarty_tpl);?>
</a>
			<span class="separator">&nbsp;</span>
