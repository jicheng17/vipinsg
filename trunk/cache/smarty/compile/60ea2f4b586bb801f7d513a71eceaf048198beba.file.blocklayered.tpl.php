<?php /* Smarty version Smarty-3.1.8, created on 2014-06-28 16:05:19
         compiled from "/var/www/vipinsg/themes/theme895/modules/blocklayered/blocklayered.tpl" */ ?>
<?php /*%%SmartyHeaderCode:77638915453ae773f51d017-01182049%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60ea2f4b586bb801f7d513a71eceaf048198beba' => 
    array (
      0 => '/var/www/vipinsg/themes/theme895/modules/blocklayered/blocklayered.tpl',
      1 => 1403942698,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '77638915453ae773f51d017-01182049',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53ae773f8c45b8_36126393',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53ae773f8c45b8_36126393')) {function content_53ae773f8c45b8_36126393($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.escape.php';
?>
...
<section id="layered_block_left" class="column_box block">
	<h3 class="toggle"><span><?php echo smartyTranslate(array('s'=>'Catalog','mod'=>'blocklayered'),$_smarty_tpl);?>
</span></h3>
		...
		<form action="#" id="layered_form">
			<div>
				...
				<div id="enabled_filters" class="titled_box">
                   <h2 class="clearfix">
					<span class="layered_subtitle"><?php echo smartyTranslate(array('s'=>'Enabled filters:','mod'=>'blocklayered'),$_smarty_tpl);?>
</span>
                    </h2>
					<ul>
...
"><i class="icon-minus-sign"></i></a></span>
						</h2>
						<ul id="ul_layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
_<?php echo $_smarty_tpl->tpl_vars['filter']->value['id_key'];?>
" class="store_list_filter ul_filter clearfix">
						<?php if (!isset($_smarty_tpl->tpl_vars['filter']->value['slider'])){?>
...
?>
									...
									<li class="nomargin <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fe']['index']>=$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']){?>hiddable<?php }?>  clearfix">
							...
							<?php }else{ ?>
								...
								<li class="nomargin row">
                                	<div class="form-group clearfix col-xs-6 col-sm-12">
										<label class="col-xs-2 control-label"><?php echo smartyTranslate(array('s'=>'From','mod'=>'blocklayered'),$_smarty_tpl);?>
</label>
                                        <div class="col-xs-9">
                                    		<input class="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
_range layered_input_range_min layered_input_range form-control" id="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
...
_range_unit col-xs-1 control-label"><?php echo $_smarty_tpl->tpl_vars['filter']->value['unit'];?>
</span>
									</div>
                                    <div class="form-group clearfix col-xs-6 col-sm-12">
                                        <label class="col-xs-2 control-label"><?php echo smartyTranslate(array('s'=>'to','mod'=>'blocklayered'),$_smarty_tpl);?>
</label>
                                        <div class="col-xs-9">
                                        	<input class="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
_range layered_input_range_max layered_input_range form-control" id="layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
...
?>
									<li class="nomargin link_type <?php if ($_smarty_tpl->tpl_vars['filter']->value['values'][1]==$_smarty_tpl->tpl_vars['values']->value[1]&&$_smarty_tpl->tpl_vars['filter']->value['values'][0]==$_smarty_tpl->tpl_vars['values']->value[0]){?>layered_list_selected<?php }?> layered_list" onclick="$('#layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
_range_min').val(<?php echo $_smarty_tpl->tpl_vars['values']->value[0];?>
);$('#layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
_range_max').val(<?php echo $_smarty_tpl->tpl_vars['values']->value[1];?>
);reloadContent();">
										<i class="icon-caret-right"></i> <?php echo smartyTranslate(array('s'=>'From','mod'=>'blocklayered'),$_smarty_tpl);?>
...
" />
	...
	<div id="layered_ajax_loader" style="display: none;">
		<p class="loader_position"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
loader-filter.gif" alt="" /></p>
	</div>
	</section>
<?php }else{ ?>
