<?php /* Smarty version Smarty-3.1.8, created on 2014-06-28 16:05:06
         compiled from "/var/www/vipinsg/themes/theme895/modules/blockcart/blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:63268646053ae6fdb258a16-19980003%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5da94928a7d2ea7a48578947be34a567588d9a1' => 
    array (
      0 => '/var/www/vipinsg/themes/theme895/modules/blockcart/blockcart-json.tpl',
      1 => 1403942698,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '63268646053ae6fdb258a16-19980003',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_53ae6fdb4a66b9_76333436',
  'variables' => 
  array (
    'products' => 0,
    'product' => 0,
...
<?php if ($_valid && !is_callable('content_53ae6fdb4a66b9_76333436')) {function content_53ae6fdb4a66b9_76333436($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.replace.php';
?>
{
"products": [
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>",
		"name":          "<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8'),15,'...',true), ENT_QUOTES, 'UTF-8'), "HTML-ENTITIES", 'UTF-8');?>
",
...
",
		"link":            "<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(($_smarty_tpl->tpl_vars['order_process']->value),true,null,"deleteDiscount=".($_smarty_tpl->tpl_vars['discount']->value['id_discount'])), ENT_QUOTES, 'UTF-8');?>
",
