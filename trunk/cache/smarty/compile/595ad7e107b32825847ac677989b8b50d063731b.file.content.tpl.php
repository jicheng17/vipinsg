<?php /* Smarty version Smarty-3.1.8, created on 2014-06-27 01:12:09
         compiled from "/var/www/vipinsg/admin_vipinsg/themes/default/template/controllers/login/content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:121538849153ac5469e41750-64823242%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '595ad7e107b32825847ac677989b8b50d063731b' => 
    array (
      0 => '/var/www/vipinsg/admin_vipinsg/themes/default/template/controllers/login/content.tpl',
      1 => 1403802536,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121538849153ac5469e41750-64823242',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53ac5469f0e9d0_28830844',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53ac5469f0e9d0_28830844')) {function content_53ac5469f0e9d0_28830844($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/var/www/vipinsg/tools/smarty/plugins/modifier.escape.php';
...
?>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['warningSslMessage']->value)){?>
		<div class="warn">
			<?php echo $_smarty_tpl->tpl_vars['warningSslMessage']->value;?>
	...
	<?php if (!isset($_smarty_tpl->tpl_vars['wrong_folder_name']->value)){?>
...
"/>
		...
		<form action="#" id="forgot_password_form" method="post" class="hide">
			...
			<p class="bold"><?php echo smartyTranslate(array('s'=>'Please enter the e-mail address you provided during the registration process in order to receive your access code by e-mail'),$_smarty_tpl);?>
</p>

			<div class="field">
				<label><?php echo smartyTranslate(array('s'=>'E-mail address:'),$_smarty_tpl);?>
</label>
	...
	<?php }else{ ?>
		<div class="padding-30">
			...
			<ul>
				...
				<li><?php echo smartyTranslate(array('s'=>'renamed the /admin folder (e.g. /admin123%d)','sprintf'=>$_smarty_tpl->tpl_vars['randomNb']->value),$_smarty_tpl);?>
</li>
			</ul>
			<p><?php echo smartyTranslate(array('s'=>'Please then access this page by the new URL (e.g. http://www.yoursite.com/admin123%d)','sprintf'=>$_smarty_tpl->tpl_vars['randomNb']->value),$_smarty_tpl);?>
</p>
		</div>
	<?php }?>
	</div>
